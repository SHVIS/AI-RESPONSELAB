    ...
    <>
      ...
      >
        <span className="inline-flex flex-1 items-center">
          <FileSearch2Icon size={20} className="mr-2" />
          <span className="text-xs text-left">Search</span>
        </span>
        <span className="flex space-x-1">
          <kbd className="px-1 py-0.5 text-xs bg-zinc-700 rounded">Ctrl</kbd>
          <kbd className="px-1 py-0.5 text-xs bg-zinc-700 rounded">F</kbd>
        </span>
      </button>

      {/* Command Dialog */}  <CommandDialog open={open} onOpenChange={setOpen}className="max-w-sm rounded-lg border">
      <Command >
        ...
        <div className="bg-zinc-900 border border-zinc-800 p-3 ">
         <CommandInput 
          ...
          />
          <CommandList className="bg-zinc-900 p-3">
      ...
      </CommandDialog> {/*Bottom navigation hints */}
    </>
  ) 
}
